...
# Test script for go-refactor pattern
...
TEST_INPUT="$SCRIPT_DIR/test-code-before.go"
TEST_EXPECTED="$SCRIPT_DIR/test-code-after.go"
OUTPUT_FILE="$SCRIPT_DIR/test-output.md"

echo "Testing go-refactor pattern..."
echo ""
